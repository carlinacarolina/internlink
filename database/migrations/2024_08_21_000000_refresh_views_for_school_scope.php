...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<'SQL'
            DROP VIEW IF EXISTS v_internship_detail;
            DROP VIEW IF EXISTS v_application_summary;
            DROP VIEW IF EXISTS v_monitoring_log_detail;
            DROP VIEW IF EXISTS v_monitoring_log_summary;
            DROP VIEW IF EXISTS internship_details_view;
            DROP VIEW IF EXISTS application_details_view;
            DROP VIEW IF EXISTS institution_details_view;
            DROP VIEW IF EXISTS supervisor_details_view;
        ...
        DB::unprepared(<<<'SQL'
            ...
            JOIN student_details_view sd       ON sd.id = a.student_id AND sd.school_id = a.school_id
